...
Navigate to the directory where you would like to store the code for this project. Run the following commands to install the project starter code or download it manually [here](https://www.dropbox.com/scl/fi/qvln1ynifpk559bbm3pcn/Project1.tar.gz?rlkey=2aquax78dhhdrdlrzo4lae2rl&st=fffyw85q&dl=0).
```bash
wget "https://www.dropbox.com/scl/fi/qvln1ynifpk559bbm3pcn/Project1.tar.gz?rlkey=2aquax78dhhdrdlrzo4lae2rl&st=fffyw85q&dl=0" -O p1.tar.gz
tar -xf p1.tar.gz
rm p1.tar.gz
```
