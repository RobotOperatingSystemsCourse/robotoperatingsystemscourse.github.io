...
1. If you downloaded the project before Sunday, March 16 at 2:30PM, remove the extra executables (`js_listener.cpp` and `tf_listener.cpp`) from `src/` and replace `test/manual_tests/joint_test.cpp` [with this new version](https://www.dropbox.com/scl/fi/jwc3w42h00xk4frl21s36/joint_test.cpp?rlkey=b37d46sea8y1q8ghpvvpihi9e&st=q3dz6nek&dl=0).
